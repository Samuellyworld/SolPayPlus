//impoorting useful modules from react
import { useState } from "react";

//importing useSelector and useDispatch from react-redux
import { useSelector, useDispatch } from "react-redux";

//importing Barloader from react-spinner library
import BarLoader from "react-spinners/BarLoader";
import {
  bottomClose,
  removeCashback,
} from "../../store/alert/alert.modal.reducer";

//impoorting RootState from redux store
...
const Alert = () => {
  ...
  const close = useSelector(
    (state: RootState) => state?.alert?.cashback?.openModal
  );
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: "green" }}>Claim Rewards;</span>
      </p>
      <BarLoader
        color={"#888"}
        size={150}
